...
var submit = $("#submit-btn-custom"); // submit button
var form = $("#contact-form-custom"); // contact form
function sendEmail() {
  //
...
-------------------------- */
  ...
  var loadingText =
    '<span role="status" aria-hidden="true" class="spinner-border spinner-border-sm align-self-center me-2"></span>Enviando...'; // change submit button text
  ...
  var raw = JSON.stringify({
    service_id: "service_saqqtjm",
    template_id: "template_ho21jsb",
    accessToken: "32txfvZtCUSpY3R1qGhOh",
    user_id: "H58eYCo8-BRxGXUo4",
    template_params: {
  ...
  fetch("https://api.emailjs.com/api/v1.0/email/send", requestOptions)
    ...
    .then((result) => {
      submit.html("Enviado!"); // reset submit button text
